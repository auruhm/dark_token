...
export class Dark_Token__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Dark_Token extends ethereum.SmartContract {
  static bind(address: Address): Dark_Token {
    return new Dark_Token("Dark_Token", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): Dark_Token__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Dark_Token__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Dark_Token__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint256)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Dark_Token__checkpointsResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
